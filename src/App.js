...
function App() {
  const Space = ParallaxJSXWrapper(
    <img
  ...
  const Earth = ParallaxJSXWrapper(
    <img
  ...
  const Moon = ParallaxJSXWrapper(
    <img src="./images/moon.png" alt="The moon." className="moon" />,
    0.03
  );
  const Rocket = ParallaxJSXWrapper(
    <img
  ...
  const Satellite = ParallaxJSXWrapper(
    <img
  ...
  const Greeting = ParallaxJSXWrapper(
      ...
      <div className="section2_container">
        <div className="left_side">
          <p>
            ...
            deserunt at! Debitis, deleniti eos voluptatibus quis, hic molestiae
            nulla sunt, pariatur dolores possimus recusandae odit deserunt
            dignissimos veniam tempore quaerat?
          </p>
        </div>
